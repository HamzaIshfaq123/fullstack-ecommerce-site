    ...
    <div className="bg-white py-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
                ...
                <div className="w-16 h-20 bg-gray-100 border-2 border-gray-300 mr-6 transform rotate-6"></div>
                <h3 className="text-xl font-semibold text-gray-800">Sign Up for the NEWSLETTER</h3>
            </div>
            <div className="flex flex-col md:flex-row items-center w-full md:w-auto">
                <input type="email" placeholder="Enter Your Email" className="px-4 py-2 border border-gray-300 rounded-l-md w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-red-500"/>
                <button className="bg-red-600 text-white px-6 py-2 rounded-r-md hover:bg-red-700 transition duration-300 w-full md:w-auto mt-2 md:mt-0">Subscribe</button>
            </div>
            <div className="flex space-x-4 mt-4 md:mt-0 ml-0 md:ml-4">
                {/* <!-- Replace with actual SVG icons for Facebook, Twitter, Instagram, Pinterest --> */}
                <a href="#" className="text-gray-500 hover:text-gray-700">F</a>
                <a href="#" className="text-gray-500 hover:text-gray-700">T</a>
                <a href="#" className="text-gray-500 hover:text-gray-700">I</a>
                <a href="#" className="text-gray-500 hover:text-gray-700">P</a>
            </div>
        </div>
    </div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p className="text-sm mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.</p>
                <p className="text-sm">1734 Stonecoal Road</p>
                <p className="text-sm">+021-95-51-84</p>
            </div>
            ...
            <div>
                ...
                <ul className="space-y-2 text-sm">
                    <li><a href="#" className="hover:text-white">Hot deals</a></li>
